...
class TelegramMessage(models.Model):
    ...
    def init(self):
        ...
        self.env.cr.execute(SQL(
            "CREATE UNIQUE INDEX IF NOT EXISTS %s ON %s (bot_id, chat_telegram_id, telegram_message_id) WHERE telegram_message_id IS NOT NULL",
            SQL.identifier(f'{self._table}_telegram_message_unique'),
