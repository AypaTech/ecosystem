...
class TelegramConversation(models.Model):
    ...
    def _assign(self, user):
        ...
        remove_previous = self.env["ir.config_parameter"].sudo().get_param(
            "telegram.remove_previous_assignee", "False") == "True"
        for conv in self:
    ...
    def _cron_auto_resolve(self):
        ...
        value = self.env["ir.config_parameter"].sudo().get_param("telegram.auto_resolve_days")
