...
class TelegramBot(models.Model):
    ...
    _sql_constraints = [
        ('webhook_key_unique', 'UNIQUE(webhook_key)', 'The webhook key must be unique.'),
        ('bot_company_unique', 'UNIQUE(bot_telegram_id, company_id)', 'This Telegram bot is already configured for this company.'),
    ]
