...
from odoo.addons.aypatech_ai_assistant.automation.tools.constants import (
    AGENT_DEFAULT_MAX_COST_EUR,
    AGENT_DEFAULT_MAX_LIFETIME_HOURS,
    AGENT_DEFAULT_MAX_RESUMES,
    AGENT_DEFAULT_MAX_TOTAL_TOKENS,
)
from odoo.addons.aypatech_ai_assistant.automation.tools.dispatch import fire_action
...
class IrActionsServer(models.Model):
    ...
    agent_max_resumes = fields.Integer(
        ...
        help=(
            ...
            'when the session resumes through a schedule; zero falls '
    ...
    agent_max_lifetime_hours = fields.Integer(
        ...
        help=(
            ...
            'Enforced when the session resumes through a schedule; zero '
