...
from odoo.addons.aypatech_ai_assistant.mcp.core.prompt import get_prompt_index
from odoo.addons.aypatech_ai_assistant.mcp.tools.logger import LoggerProxy
from odoo.addons.aypatech_ai_assistant.mcp.tools.protocol import (
    make_prompt_message,
    make_text_content,
)
...
class MCPPrompt(models.Model):
    ...
    def _run_method_prompt(
        ...
        mixin = self.env['aypatech_mcp.mixin']
