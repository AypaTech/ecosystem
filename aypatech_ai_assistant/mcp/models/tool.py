...
from odoo.addons.aypatech_ai_assistant.mcp.tools.encoder import encode_request, encode_response
from odoo.addons.aypatech_ai_assistant.mcp.tools.exception import MCPScopeDenied
from odoo.addons.aypatech_ai_assistant.mcp.tools.logger import LoggerProxy
from odoo.addons.aypatech_ai_assistant.mcp.tools.protocol import ToolContent, ToolResult
from odoo.addons.aypatech_ai_assistant.webutils.tools.encoder import RecordEncoder


class MCPTool(models.Model):
    """Tool definition exposed to MCP clients and executed on demand."""

    _name = 'aypatech_mcp.tool'
    ...
    def _notify_tools_changed(self) -> None:
        ...
        with contextlib.suppress(Exception):
            self.env['aypatech_mcp.notification'].push_to_all_sessions(
