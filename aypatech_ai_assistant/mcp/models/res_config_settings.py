...
class ResConfigSettings(models.TransientModel):
    """Add MCP session, logging and rate-limit options to the settings."""
    ...
    mcp_session_timeout = fields.Integer(
        ...
        config_parameter='aypatech_ai_assistant.mcp_session_timeout_hours',
        default=24,
    ...
    mcp_log_retention = fields.Integer(
        ...
        config_parameter='aypatech_ai_assistant.mcp_log_autovacuum_days',
        default=30,
    ...
    mcp_rate_limit_requests = fields.Integer(
        ...
        config_parameter='aypatech_ai_assistant.mcp_rate_limit_requests',
        default=60,
    ...
    mcp_annotate_messages = fields.Boolean(
        ...
        config_parameter='aypatech_ai_assistant.mcp_annotate_messages',
        default=True,
        help=(
