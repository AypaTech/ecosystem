...
from odoo.addons.aypatech_ai_assistant.mcp.tools.rate_limit import rate_limiter


class MCPKey(models.Model):
    """Hashed MCP API key with per-key scope and rate limit."""

    _name = 'aypatech_mcp.key'
    ...
    def generate_playground_key(
        ...
        rate_limit = (
            ...
            .sudo()
            .get_int('aypatech_ai_assistant.mcp_rate_limit_requests', 60)
        )
