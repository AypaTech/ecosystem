...
from odoo.addons.aypatech_ai_assistant.mcp.tools.descriptions import context_field, ids_field
from odoo.addons.aypatech_ai_assistant.mcp.tools.parser import normalize_ids
