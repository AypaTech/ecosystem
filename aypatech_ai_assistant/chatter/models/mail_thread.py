...
class MailThread(models.AbstractModel):
    ...
    def _ai_session_chatter_domain(self) -> list:
        ...
        Only a settings administrator is let past that, the way ``aypatech_ai``
    ...
    def _ai_split_mentioned_agents(
        ...
        """
        empty = self.env['aypatech_ai.agent']
        if not partner_ids:
        ...
        if not self.env['aypatech_ai.session'].has_access('create'):
