...
from odoo.addons.aypatech_ai_assistant.tests.common import AITestCommon, html_result
from odoo.addons.aypatech_ai_assistant.ai.tools.url_fetch import FetchResult, page_icon, render_content
