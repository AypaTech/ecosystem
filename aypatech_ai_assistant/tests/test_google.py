...
from odoo.addons.aypatech_ai_assistant.ai.providers.google import GoogleProvider
...
class TestAiGoogleProvider(AITestCommon):
    ...
    def test_rejected_thinking_level_is_stripped_and_served(self):
        record = self.env.ref('aypatech_ai_assistant.model_gemini_3_flash_preview')
        bodies = []
