...
class TestAgentHandoff(AITestCommon):
    ...
    def setUpClass(cls) -> None:
        super().setUpClass()
        agents = cls.env['aypatech_ai.agent']
    ...
    def _session(self, agent: models.Model) -> models.Model:
        ...
        return self.env['aypatech_ai.session'].create(
    ...
    def _mixin(self, session: models.Model) -> models.Model:
        ...
        return self.env['aypatech_mcp.mixin'].with_context(aypatech_mcp_session_id=session.id)
    ...
    def _switch_events(self, session: models.Model) -> models.Model:
        ...
        return self.env['aypatech_ai.session.event'].search(
