...
class TestAiSession(AITestCommon):
    ...
    def test_max_iterations_is_configurable(self):
        self.env['ir.config_parameter'].sudo().set_str('aypatech_ai_assistant.ai_max_iterations', '3')
    ...
    def test_int_config_param_falls_back_on_invalid(self):
        ...
        ICP.set_str('aypatech_ai_assistant.ai_max_iterations', '7')
        self.assertEqual(self.session._max_iterations(), 7)
        ICP.set_str('aypatech_ai_assistant.ai_max_iterations', 'nonsense')
        self.assertEqual(self.session._max_iterations(), MAX_ITERATIONS)
        ICP.set_str('aypatech_ai_assistant.ai_max_iterations', '0')
        self.assertEqual(self.session._max_iterations(), MAX_ITERATIONS)

    def test_slice_wallclock_bounded_by_cron_limit(self):
        ICP = self.env['ir.config_parameter'].sudo()
        ICP.set_str('aypatech_ai_assistant.ai_slice_wallclock_seconds', '99999')
        ...
        ICP.set_str('aypatech_ai_assistant.ai_slice_wallclock_seconds', '15')
