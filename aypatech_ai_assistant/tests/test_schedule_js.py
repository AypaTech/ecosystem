...
class TestHoot(odoo.tests.HttpCase):
    """Run the aypatech_ai_schedule HOOT JavaScript test suite."""
    ...
    def setUpClass(cls) -> None:
        ...
        cls.hoot_user = new_test_user(
            cls.env,
            login='hoot_aypatech_ai_schedule',
            password='hoot_aypatech_ai_schedule',
    ...
    @odoo.tests.no_retry
    def test_hoot_aypatech_ai_schedule(self):
        self.browser_js(
            '/web/tests?headless&loglevel=2&preset=desktop&timeout=15000'
            '&tag=aypatech_ai_schedule',
            '',
            '',
