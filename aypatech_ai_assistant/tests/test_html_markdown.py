from odoo.addons.aypatech_ai_assistant.tests.common import HTML_PAGE, AITestCommon
from odoo.addons.aypatech_ai_assistant.ai.tools.parser import extract_title, html_to_markdown
