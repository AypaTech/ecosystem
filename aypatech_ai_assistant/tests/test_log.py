...
from odoo.addons.aypatech_ai_assistant.tests.common import RegistryTestModeMixin
...
class TestMcpLog(RegistryTestModeMixin, common.TransactionCase):
    ...
    def test_key_snapshot_survives_key_deletion(self):
        key_model = self.env['aypatech_mcp.key']
