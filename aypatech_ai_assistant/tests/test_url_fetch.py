...
from odoo.addons.aypatech_ai_assistant.ai.tools.url_fetch import (
    CONNECT_TIMEOUT,
    READ_TIMEOUT,
    _validate_url,
    fetch_url,
...
class TestUrlFetchHardening(AITestCommon):
    ...
    def test_https_only(self):
        ...
        with patch(
            'odoo.addons.aypatech_ai_assistant.ai.tools.url_fetch.urllib3.HTTPSConnectionPool',
        ) as mock_pool_cls:
    ...
    def test_rejects_private_ip(self):
        ...
        with (
            patch(
                'odoo.addons.aypatech_ai_assistant.ai.tools.url_fetch.socket.getaddrinfo',
    ...
    def test_github_blob_rewritten_to_raw(self):
        ...
        with (
            ...
            result = fetch_url('https://github.com/odoo/odoo/blob/19.0/README.md')
        self.assertEqual(
            result.url,
            'https://raw.githubusercontent.com/odoo/odoo/19.0/README.md',
        )
        self.assertEqual(
