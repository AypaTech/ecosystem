...
class ScheduleTestCommon(TransactionCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.agent = cls.env['aypatech_ai.agent'].create({'name': 'Schedule Test Agent'})
        cls.partner_model = cls.env['ir.model']._get('res.partner')
        cls.Session = cls.env['aypatech_ai.session']
        cls.Schedule = cls.env['aypatech_ai.schedule']
        cls.Mixin = cls.env['aypatech_mcp.mixin']
        cls.Event = cls.env['aypatech_ai.session.event']
    ...
    def _mixin_for(self, session: models.BaseModel) -> models.BaseModel:
        ...
        return self.Mixin.with_context(aypatech_mcp_session_id=session.id)
