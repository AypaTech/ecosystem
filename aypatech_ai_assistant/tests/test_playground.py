...
class TestPlayground(common.TransactionCase):
    ...
    def setUpClass(cls) -> None:
        super().setUpClass()
        cls.Key = cls.env['aypatech_mcp.key']
        cls.Tool = cls.env['aypatech_mcp.tool']
    ...
    def test_menu_descends_from_mcp_root(self):
        menu = self.env.ref('aypatech_ai_assistant.mcp_menu_mcp_playground')
        root = self.env.ref('aypatech_ai_assistant.mcp_menu_mcp_root')
