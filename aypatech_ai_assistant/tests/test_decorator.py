...
from odoo.addons.aypatech_ai_assistant.mcp.core import tool as core_tool
...
class TestMcpDecoratorTool(common.TransactionCase):
    ...
    def setUp(self) -> None:
        ...
        registry._aypatech_mcp_method_cache = dict(TEST_REGISTRY)
        registry._aypatech_mcp_method_cache_key = len(registry._init_modules or ())
    ...
    def test_scanner_finds_decorated_method_on_live_registry(self):
        ...
        try:
            ...
            self.assertEqual(entry['model'], 'aypatech_mcp.mixin')
    ...
    def test_recordset_result_serialized_via_record_encoder(self):
        ...
        self.env.registry._aypatech_mcp_method_cache['mcp_test_record'] = {
            'kind': 'method',
            'model': 'res.partner',
