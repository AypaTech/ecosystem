...
import '@aypatech_ai_assistant/ai/views/fields/effort_picker/effort_picker';
...
class AypaTechAiEffortModel extends models.Model {
    _name = 'aypatech_ai_assistant.ai_effort_model';
...
defineModels([AypaTechAiEffortModel]);

test('EffortPickerField limits choices to the supported options', async () => {
    await mountView({
        resModel: 'aypatech_ai_assistant.ai_effort_model',
        resId: 1,
        type: 'form',
        arch: ARCH,
    });
