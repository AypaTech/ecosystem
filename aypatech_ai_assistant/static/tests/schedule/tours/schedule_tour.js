...
registry.category('web_tour.tours').add('aypatech_ai_schedule_tour', {
    steps: () => [
        {
        ...
        {
            trigger: '.o_kanban_record:contains("Tour Digest") .ayp_schedule_countdown',
        ...
        {
            trigger: '.o_form_view .ayp_schedule_countdown',
