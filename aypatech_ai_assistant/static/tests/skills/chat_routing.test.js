...
import { getSkills } from '@aypatech_ai_assistant/skills/chat/skill_cache';
import '@aypatech_ai_assistant/skills/chat/chat';
...
function registerMocks({ skills = [{ name: 'alpha' }], failInvoke = false } = {}) {
    ...
    onRpc('aypatech_ai.session', 'available_skill_names', () => skills);
    onRpc('aypatech_ai.session', 'invoke_skill_from_chat', ({ args, kwargs }) => {
