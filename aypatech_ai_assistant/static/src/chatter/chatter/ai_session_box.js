import { Component, onWillStart, onWillUnmount, onWillUpdateProps, proxy, t, useProps } from '@odoo/owl';
...
export class AISessionBox extends Component {
    static template = 'aypatech_ai_assistant.chatter_AISessionBox';
    props = useProps({
        threadModel: t.string(),
        threadId: t.or([t.number(), t.string()]),
    ...
    setup() {
        ...
        this.bus.subscribe('aypatech_ai_assistant.ai_event', this._busHandler);
        onWillUnmount(() => {
            this.bus.unsubscribe('aypatech_ai_assistant.ai_session_state', this._busHandler);
            this.bus.unsubscribe('aypatech_ai_assistant.ai_event', this._busHandler);
