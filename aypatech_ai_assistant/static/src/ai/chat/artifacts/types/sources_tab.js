...
export class SourceIcon extends Component {
    static template = 'aypatech_ai_assistant.ai_SourceIcon';
    props = useProps({
        source: t.object(),
    });
    setup() {
        this.state = proxy({ iconFailed: false });
    }
    get iconUrl() {
...
export class SourceCard extends Component {
    static template = 'aypatech_ai_assistant.ai_SourceCard';
    static components = { SourceIcon };
    props = useProps({
        source: t.object(),
        sessionId: t.or([t.number(), t.string()]).optional(),
    });
    setup() {
...
export class SourceList extends Component {
    static template = 'aypatech_ai_assistant.ai_SourceList';
    static components = { SourceCard };
    props = useProps({
        sources: t.array(),
        cap: t.number().optional(),
        sessionId: t.or([t.number(), t.string()]).optional(),
    });
    setup() {
...
export class SourcesTab extends Component {
    static template = 'aypatech_ai_assistant.ai_SourcesTab';
