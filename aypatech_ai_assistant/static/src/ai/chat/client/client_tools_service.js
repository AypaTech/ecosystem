 ...
 * a client action whose tool is registered in `aypatech_ai_assistant.ai_client_tools`, runs
...
export const webclientClientToolsService = {
    ...
    start(env, { bus_service: bus, orm }) {
        ...
        bus.subscribe('aypatech_ai_assistant.ai_event', onEvent);
        return {};
    },
};

registry.category('services').add('aypatech_ai_assistant.ai_client_tools', webclientClientToolsService);
