...
import { toolResultFiles } from '@aypatech_ai_assistant/ai/core/attachment/tool_files';

export const toolBlockDecorators = registry.category('aypatech_ai_assistant.ai_tool_block_decorators');
