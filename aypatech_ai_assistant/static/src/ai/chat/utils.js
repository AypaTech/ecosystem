...
const STATUS_BADGE_CLASSES = {
    ...
    compacting: 'ayp_state_running',
    waiting: 'ayp_state_waiting',
    waiting_schedule: 'ayp_state_waiting',
    done: 'ayp_state_done',
...
export function statusBadgeClass(status) {
    return STATUS_BADGE_CLASSES[status] || 'ayp_state_new';
}
...
export function approvalPill(state) {
    ...
    return {
        ...
        className: `${isOff ? 'ayp_approval_bypass' : 'ayp_approval_ask'}${
            override ? ' ayp_approval_override' : ''
