...
export class AIShareDialog extends Component {
    static template = 'aypatech_ai_assistant.ai_ShareDialog';
    ...
    setup() {
        ...
        this.state = proxy({ fieldInfo: null, dirty: false });
        this.record = null;
        this.hooks = {
    ...
    async save() {
        ...
        if (list) {
            await this.orm.write('aypatech_ai.session', [this.props.sessionId], {
