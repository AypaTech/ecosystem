import { Component, markup, proxy, useProps } from '@odoo/owl';
...
import { formatTimestamp } from '@aypatech_ai_assistant/ai/chat/utils';
import {
    askArgsText,
    askViewMode,
    toggleAskViewMode,
...
export class SessionEventsField extends Component {
    static template = 'aypatech_ai_assistant.ai_SessionEventsField';
