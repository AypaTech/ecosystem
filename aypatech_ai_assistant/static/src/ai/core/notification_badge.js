 ...
 * "aypatech_ai_assistant.ai_notification_badge" bus channel.
 *
...
export function useNotificationBadge() {
    ...
    onWillStart(async () => {
        ...
        try {
            initial = await orm.call('aypatech_ai.session', 'notification_badge', []);
        } catch {
    ...
    bus.subscribe('aypatech_ai_assistant.ai_notification_badge', applyPush);
    onWillUnmount(() => bus.unsubscribe('aypatech_ai_assistant.ai_notification_badge', applyPush));
    return badge;
}
