 ...
 *
 * @param {object} payload The ``aypatech_ai_assistant.ai_session_notification`` bus payload.
    ...
    start(env) {
        ...
        function dismissInbox(sessionId) {
            env.services.orm.silent
                .call('aypatech_ai.session', 'dismiss_notifications', [[sessionId]])
                .catch(() => {});
        }
...
registry
    .category('services')
    .add('aypatech_ai_assistant.ai_session_notification', sessionNotificationService);
