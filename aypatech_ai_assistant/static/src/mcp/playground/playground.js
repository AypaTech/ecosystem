...
const LAST_TOOL_STORAGE_KEY = 'aypatech_ai_assistant.mcp_playground.last_tool';
const ACTIVE_PANEL_STORAGE_KEY = 'aypatech_ai_assistant.mcp_playground.active_panel';
const TOOLS_PANEL_ID = 'tools';

/**
 * Root client action rendering the MCP playground: tool browser, key bar, and
 * pluggable side panels contributed via the `aypatech_ai_assistant.mcp_playground.panels` registry.
 */
export class Playground extends Component {
    static template = 'aypatech_ai_assistant.mcp_Playground';
    ...
    setup() {
        ...
        onMounted(() => {
            const search = this.rootRef()?.querySelector(
                '.o_aypatech_mcp_list input[type=search]',
            );
            search?.focus();
        });
        onWillUnmount(() => {
     ...
     * contributed to the `aypatech_ai_assistant.mcp_playground.panels` registry, sorted by sequence.
    ...
    get panels() {
        ...
        const extras = registry
            .category('aypatech_ai_assistant.mcp_playground.panels')
            .getEntries()
...
registry.category('actions').add('aypatech_ai_assistant.mcp_playground', Playground);
