...
const LAST_PROMPT_STORAGE_KEY = 'aypatech_ai_assistant.mcp_playground.last_prompt';
const ARGS_STORAGE_PREFIX = 'aypatech_ai_assistant.mcp_playground.prompt_args::';
...
export class PromptsPanel extends Component {
    static template = 'aypatech_ai_assistant.mcp_PromptsPanel';
...
registry.category('aypatech_ai_assistant.mcp_playground.panels').add('prompts', {
    label: _t('Prompts'),
    icon: 'fa-comment-o',
    sequence: 10,
