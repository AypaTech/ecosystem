...
class Skill(models.Model):
    ...
    _name = 'aypatech_ai.skill'
    _description = 'AI Skill'
    _inherit = ['aypatech_ai_assistant.ai_revision.mixin', 'aypatech_ai_assistant.ai_prompt.mixin']
    ...
    model_ids = fields.Many2many(
        ...
        relation='aypatech_ai_skill_ir_model_rel',
        column1='skill_id',
        column2='model_id',
        string='Models',
        help=(
    ...
    user_ids = fields.Many2many(
        comodel_name='res.users',
        relation='aypatech_ai_skill_res_users_rel',
        column1='skill_id',
        column2='user_id',
        string='Shared With',
        help=(
    ...
    agent_ids = fields.Many2many(
        ...
        relation='aypatech_ai_skill_agent_rel',
        column1='skill_id',
        column2='agent_id',
        string='Agents',
        help=(
    ...
    attachment_ids = fields.Many2many(
        ...
        relation='aypatech_ai_skill_ir_attachment_rel',
        column1='skill_id',
    ...
    def _relink_attachments(self) -> None:
        ...
        ``aypatech_ai.session._resolve_attachments``.
        """
        for record in self:
            pending = record.attachment_ids.filtered(
                lambda attachment: (
                    attachment.res_model == 'aypatech_ai.skill' and not attachment.res_id
                )
            )
            if pending:
    ...
    def fetch_skills(self, skill_type: str) -> list[dict]:
        ...
        skills = self.env['aypatech_ai.session']._dedupe_visible_skills(
