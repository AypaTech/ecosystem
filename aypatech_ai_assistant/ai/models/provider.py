...
from odoo.addons.aypatech_ai_assistant.ai.providers import REGISTRY
from odoo.addons.aypatech_ai_assistant.ai.providers.base import ProviderBase
...
class AIProvider(models.Model):
    ...
    def _effective_reasoning_effort(
        ...
        """
        record = self.env['aypatech_ai.model'].search(
            [
                ('provider_id', '=', self.id),
