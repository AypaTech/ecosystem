...
class AIAgent(models.Model):
    ...
    _name = 'aypatech_ai.agent'
    _description = 'AI Agent'
    _inherit = [
        'image.mixin',
        'mail.thread',
        'mail.activity.mixin',
        'aypatech_ai_assistant.ai_revision.mixin',
        'aypatech_ai_assistant.ai_prompt.mixin',
    ]
    ...
    model_id = fields.Many2one(
        comodel_name='aypatech_ai.model',
        string='Model',
        help=(
    ...
    suggestion_ids = fields.One2many(
        comodel_name='aypatech_ai.agent.suggestion',
        string='Suggestions',
    ...
    def _resolve_model(self) -> models.BaseModel:
        ...
        return provider.default_model_id if provider else self.env['aypatech_ai.model']
    ...
    def _get_placeholder_filename(self, field: str) -> str:
        ...
        if field in ('image_1920', 'image_1024', 'image_512', 'image_256', 'image_128'):
            return 'aypatech_ai_assistant/static/description/icon.png'
    ...
    def _compute_session_count(self) -> None:
        ...
        grouped = self.env['aypatech_ai.session']._read_group(
