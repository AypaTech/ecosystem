...
class ResConfigSettings(models.TransientModel):
    ...
    ai_max_iterations = fields.Integer(
        ...
        config_parameter='aypatech_ai_assistant.ai_max_iterations',
        default=20,
    )
    ...
    ai_slice_wallclock_seconds = fields.Integer(
        ...
        config_parameter='aypatech_ai_assistant.ai_slice_wallclock_seconds',
        default=600,
    )
    ...
    ai_turn_wallclock_seconds = fields.Integer(
        ...
        config_parameter='aypatech_ai_assistant.ai_turn_wallclock_seconds',
        default=3600,
    )
    ...
    ai_turn_cost_limit = fields.Float(
        ...
        config_parameter='aypatech_ai_assistant.ai_turn_cost_limit',
    )
    ...
    ai_session_retention_enabled = fields.Boolean(
        ...
        config_parameter='aypatech_ai_assistant.ai_session_retention_enabled',
    )
    ...
    ai_session_retention_days = fields.Integer(
        ...
        config_parameter='aypatech_ai_assistant.ai_session_retention_days',
        default=90,
    )
    ...
    ai_client_action_timeout = fields.Integer(
        ...
        config_parameter='aypatech_ai_assistant.ai_client_action_timeout',
        default=600,
    )
