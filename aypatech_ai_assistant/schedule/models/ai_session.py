...
from odoo.addons.aypatech_ai_assistant.automation.tools.dispatch import post_session_event
...
class AISession(models.Model):
    ...
    schedule_id = fields.Many2one(
        comodel_name='aypatech_ai.schedule',
        string='Schedule',
    ...
    def create(self, vals_list: list[dict]) -> AISession:
        ...
        Schedule = self.env['aypatech_ai.schedule'].sudo()
