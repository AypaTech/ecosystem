...
export const REFRESH_VIEW_EVENT = 'aypatech_odoo_community_template.refresh-view';
...
export const refreshService = {
    ...
    start(env, { bus_service, action: actionService }) {
        ...
        bus_service.subscribe('aypatech_odoo_community_template.reload', (payload) => {
...
registry.category('services').add('aypatech_odoo_community_template.reload', refreshService);
