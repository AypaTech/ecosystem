...
class ColorAssetsEditor(models.AbstractModel):
    ...
    _name = 'aypatech_odoo_community_template.color_assets_editor'
    ...
    def _get_color_variable(self, content: str, variable: str) -> str | bool:
        """Extract the value of a single ``$apt_`` color variable from content."""
        value = re.search(rf'\$apt_{variable}\:?\s(.*?);', content)
