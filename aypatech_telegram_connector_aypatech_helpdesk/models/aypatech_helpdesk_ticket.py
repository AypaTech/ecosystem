...
class AypatechHelpdeskTicket(models.Model):
    _inherit = "aypatech.helpdesk.ticket"

    telegram_conversation_ids = fields.One2many("telegram.conversation", "aypatech_ticket_id", string="Telegram Conversations")
    ...
    def action_open_telegram_conversations(self):
        ...
        action["domain"] = [("aypatech_ticket_id", "=", self.id)]
        action["context"] = {}
        return action
